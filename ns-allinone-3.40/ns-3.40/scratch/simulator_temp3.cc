...
NS_LOG_COMPONENT_DEFINE("simulator_temp3");

int
main(int argc, char *argv[]) {
    NS_LOG_UNCOND("simulator_temp3.cc");

    uint32_t payloadSize = 1400;
    double simulationTime{11};
    std::size_t be_nStations{2};
    int gi = 800;
...
*/
    ...
    for(int i = 0; i < (int)be_nStations; i++)
    {
        ...
        be_client1.SetAttribute("DataRate", StringValue("40Mb/s"));
    ...
    /*for (int i = 0; i < (int) be_nStations; i++) {
        ...
        be_client4.SetAttribute("DataRate", StringValue("1Mb/s"));
